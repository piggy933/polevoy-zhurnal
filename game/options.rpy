...
define config.name = _("полевой журнал. Фрязино. 2000")
...
define gui.about = _p("""полевой журнал. Фрязино. 2000

Видеоигра посвящена фрязинскому музыканту Р.Е. Сидорову. Родился в 1974 году, умер в 2003. Светлая память. С уважением, автор игры Павел.""")
